...
import com.example.mealplanner.ui.screens.addmeal.AddMealScreen
import com.example.mealplanner.ui.screens.calories.CaloriesCalculatorScreen
import com.example.mealplanner.ui.screens.daydetail.DayDetailScreen
import com.example.mealplanner.ui.screens.home.HomeScreen
import com.example.mealplanner.ui.screens.login.LoginScreen
import com.example.mealplanner.ui.screens.mealplanner.MealPlannerScreen
import com.example.mealplanner.ui.screens.mealslot.MealSlotScreen
import com.example.mealplanner.ui.screens.profile.ProfileScreen
import com.example.mealplanner.ui.screens.recipe.RecipeBuilderScreen
import com.example.mealplanner.ui.screens.signup.SignUpScreen
import com.example.mealplanner.ui.screens.splash.SplashScreen
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(
                ...
                val dayName = back.arguments?.getString("dayName") ?: ""
                DayDetailScreen(
                    dayName     = dayName,
                    viewModel   = mealPlannerViewModel,
                    onSlotClick = { slotName -> navController.navigate(NavRoutes.mealSlot(dayName, slotName)) },
            ...
            composable(
                ...
                val dayName  = back.arguments?.getString("dayName")  ?: ""
                val slotName = back.arguments?.getString("slotName") ?: ""
                MealSlotScreen(
                    dayName   = dayName,
                    slotName  = slotName,
                    viewModel = mealPlannerViewModel,
